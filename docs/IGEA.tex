...
\begin{document}
    ...
    Prima di procedere con le operazioni di pulizia dei dati, è stata condotta
    un’analisi preliminare del dataset per comprenderne la struttura e le principali caratteristiche statistiche.
