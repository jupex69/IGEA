...
% ------------------------------------------
    ...
    cross-validation), grazie al quale sono state esplorate diverse configurazioni relative alla profondità massima
    ...
    Di seguito le configurazioni ottimali trovate per entrambe le pipeline che risultano essere motlo simili.
    \begin{table}[h]
        \centering
        \begin{tabular}{lcccc}
            \hline
            \textbf{Pipeline} & \textbf{Criterion} & \textbf{Max Depth} & \textbf{Min Samples Leaf} & \textbf{Min Samples Split} \\
            \hline
            Pipeline 1 & gini     & 8 & 14 & 3 \\
            Pipeline 2 & entropy  & 8 & 14 & 3 \\
            \hline
        \end{tabular}
        \caption{Configurazioni ottimali degli iperparametri del Decision Tree ottenute tramite Grid Search}
...
% ------------------------------------------
    ...
    \includegraphics[width=1.1\textwidth]{images/graphs/graficoPrestazioni} \\
...
% -------------------------------------------------------------------------
    ...
    \paragraph{Convergenza sulla Pipeline 1}
    ...
    \paragraph{Divergenza sulla Pipeline 2}
    Nella \textbf{Pipeline 2} invece i due modelli mostrano una significativa differenza
    ...
    il Decision Tree privilegia la variabile che consente la migliore separazione
    globale della popolazione, mentre la Logistic Regression enfatizza condizioni
    meno frequenti ma associate a un forte incremento della probabilità di depressione.
