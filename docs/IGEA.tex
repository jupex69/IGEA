...
% ==========================================
    ...
    \paragraph{Feature Selection}
            Analogamente alla pipeline 1, è stata rimossa la feature \textbf {city}: fortemente dipendente dal contesto geografico indiano e quindi non generalizzabile ad altri contesti universitari;
