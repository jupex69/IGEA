    ...
    \subsection{Specifica PEAS}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|l|p{10cm}|}
                ...
                \hline
                \textbf{Performance} & La misura di prestazione adottata prevede la minimizzazione dei tempi per la ricerca di una mossa che sia valida e, al tempo stesso, la migliore possibile. \\
                \hline
                \textbf{Environment} & L'ambiente in cui opera l'agente è costituito dall'insieme di tutte le possibili configurazioni che la scacchiera può assumere. \\
                \hline
                \textbf{Actuators} & L'agente agisce sull'ambiente tramite la mossa migliore trovata. \\
                \hline
                \textbf{Sensors} & L'agente percepisce l'ambiente tramite la scacchiera virtuale a cui sono associate tutte le informazioni della partita (giocatore attuale, mosse possibili...). \\
                \hline
            \end{tabular}
