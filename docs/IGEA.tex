...
% ==========================================
    ...
    \subsection{Feature scaling}
        ...
        \begin{itemize}
            \item \textbf{Conservazione del significato fisico}: l'utilizzo dei valori non normalizzati consente di preservare il significato fisico delle variabili, facilitando sia l'analisi esplorativa dei dati sia l’interpretazione dei risultati del modello, in quanto l’effetto delle caratteristiche sul target può essere valutato direttamente nelle rispettive unità di misura.
            \item \textbf{Coerenza con i modelli adottati}: le pipeline di progetto prevedono l'utilizzo di algoritmi \textit{classificazione} che non basano il proprio funzionamento su metriche di distanza o combinazioni lineari delle caratteristiche.
        \end{itemize}
