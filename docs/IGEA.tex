...
% ==========================================
    ...
    \subsubsection{Feature engineering}
        ...
        \paragraph{Feature Transformation CGPA}
            ...
            La variabile \textit{CGPA}, originariamente espressa su scala decimale, è stata convertita in una rappresentazione su scala trentesimale,
            al fine di rendere i valori più facilmente interpretabili nel contesto universitario italiano.
            La conversione è stata effettuata mediante una trasformazione lineare,
            mantenendo invariata la relazione tra i valori:

            [
                CGPA_{30} = CGPA \times 3
            ]

            Tale trasformazione non altera le proprietà statistiche della variabile né influisce sul processo di apprendimento del modello,
